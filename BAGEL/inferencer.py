...
class InterleaveInferencer:
    ...
    def update_context_text(self, text, gen_context):
        ...
        #     generation_input[key] = generation_input[key].to(self.model.device)
    ...
    def interleave_inference(
        ...
        image_understanding_to_image=False,  # 新功能：使用SigLIP处理图像，然后生成新图像
    ...
    def __call__(
        ...
        image_understanding_to_image: bool = False,  # 新参数：启用图像理解到图像生成功能
        **kargs
    ) -> Dict[str, Any]:
        ...
        # 如果启用图像理解到图像功能，但用户没有提供文本，添加默认提示词
        ...
        # 将新参数传递给interleave_inference方法
        output_list = self.interleave_inference(input_list, image_understanding_to_image=image_understanding_to_image, **kargs)
